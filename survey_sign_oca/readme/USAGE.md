A smart-button will be displayed on the participations form view of the linked sign
requests.
...
Answers for multiple choice questions are displayed as a sequence if you add the question in placeholder.
If you suffix the question in placeholder with specific answer then it will be displayed or checked if it is the answer.

Answers of yes/no type are shown in text fields as Yes/No and in check fields as
checked/unchecked.
